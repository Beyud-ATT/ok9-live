...
export default function Privacy() {
  return (
    <div className="max-w-screen-md mx-auto text-white space-y-4">
      ...
      >
        Chính Sách Bảo Mật Thông Tin - NEW88
      </Typography.Title>
      <p>
        {" "}
        NEW88 cam kết bảo vệ quyền riêng tư của khách hàng với các tiêu chuẩn an
      ...
      <Typography.Title
        ...
        className="!text-[var(--color-brand-primary)]"
      >
        1. Bảo Mật Thông Tin Cá Nhân tại NEW88
      </Typography.Title>{" "}
      <p>
        {" "}
        Tại NEW88, chúng tôi luôn giữ bảo mật tuyệt đối dữ liệu cá nhân của
      ...
      <p>
        {" "}
        - Khi khách hàng không thể truy cập vào trang web của NEW88 có thể gửi
        tin nhắn trực tiếp đến email chính thức admin@new88.com hệ thống sẽ phản
      ...
      <Typography.Title
        ...
        className="!text-[var(--color-brand-primary)]"
      >
        NEW88 - Nơi Khách Hàng Đặt Niềm Tin
      </Typography.Title>{" "}
      <p>
        {" "}
        Với chính sách bảo mật minh bạch, hệ thống công nghệ tiên tiến và cam
        kết bảo vệ quyền lợi khách hàng, NEW88 mang đến sự an tâm tuyệt đối. Hãy
